...
class DomainRandomization():
    ...
    def generate_model_sdf(self,grasp_axis_offset=[-0.02,0.0,0.05],control_mode="full"):
        print("\n\n")
        print("self.load_ws::",self.load_ws)
        print("calling::generate_model_sdf")
        print("\n\n")
        subprocess.call(['bash', self.shell_path, 'true', 'false',str(self.folder_path),str(self.lib_path),self.str_bool(self.load_ws),self.str_bool(self.load_ws_pcd),control_mode,self.list_to_str(grasp_axis_offset)])
